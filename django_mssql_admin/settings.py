"""
Django settings for django_mssql_admin project.
...
SECRET_KEY = 'q(kv#no^rn@7$+^jqxs&mo48yff%t1a&m&$+j9-!0$)ltjz%9g'
...
ROOT_URLCONF = 'django_mssql_admin.urls'
...
WSGI_APPLICATION = 'django_mssql_admin.wsgi.application'
